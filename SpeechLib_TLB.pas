...
// *********************************************************************//
  ISpeechObjectTokenDisp = dispinterface
    ...
    procedure SetId(const _Id: WideString; const CategoryID: WideString; CreateIfNotExist: WordBool); dispid 5;
...
// *********************************************************************//
  ISpeechObjectTokenCategoryDisp = dispinterface
    ...
    procedure SetId(const _Id: WideString; CreateIfNotExist: WordBool); dispid 3;
...
// *********************************************************************//
  ISpeechRecoGrammarDisp = dispinterface
    ...
    procedure CmdSetRuleState(const Name: WideString; _State: SpeechRuleState); dispid 12;
    procedure CmdSetRuleIdState(RuleId: Integer; _State: SpeechRuleState); dispid 13;
    ...
    procedure DictationSetState(_State: SpeechRuleState); dispid 16;
    procedure SetWordSequenceData(const Text: WideString; TextLength: Integer; 
...
// *********************************************************************//
  ISpeechGrammarRuleStateDisp = dispinterface
    ...
    procedure AddRuleTransition(const DestinationState: ISpeechGrammarRuleState; 
                                const _Rule: ISpeechGrammarRule; const PropertyName: WideString; 
...
// *********************************************************************//
  ISpeechPhraseInfoDisp = dispinterface
    ...
    function GetText(StartElement: Integer; _Elements: Integer; UseReplacements: WordBool): WideString; dispid 15;
    function GetDisplayAttributes(StartElement: Integer; _Elements: Integer; 
...
// *********************************************************************//
  ISpeechLexiconDisp = dispinterface
    ...
    function GetWords(Flags: SpeechLexiconType; out _GenerationId: Integer): ISpeechLexiconWords; dispid 2;
    procedure AddPronunciation(const bstrWord: WideString; LangId: Integer; 
    ...
    function GetGenerationChange(var _GenerationId: Integer): ISpeechLexiconWords; dispid 8;
  end;
...
// *********************************************************************//
  ISpNotifySource = interface(IUnknown)
    ...
    function SetNotifyWindowMessage({var }hWnd: {_RemotableHandle}HWND; Msg: SYSUINT; wParam: UINT_PTR; 
                                    lParam: LONG_PTR): HResult; stdcall;
...
// *********************************************************************//
  ...
  public
    ...
    function SetPropertyNumber(const _Name: WideString; Value: Integer): WordBool;
    function GetPropertyNumber(const _Name: WideString; var Value: Integer): WordBool;
    function SetPropertyString(const _Name: WideString; const Value: WideString): WordBool;
    function GetPropertyString(const _Name: WideString; var Value: WideString): WordBool;
    function IsUISupported(const TypeOfUI: WideString): WordBool; overload;
    function IsUISupported(const TypeOfUI: WideString; const ExtraData: OleVariant): WordBool; overload;
    procedure DisplayUI(hWndParent: Integer; const Title: WideString; const TypeOfUI: WideString); overload;
    procedure DisplayUI(hWndParent: Integer; const Title: WideString; const TypeOfUI: WideString; 
  ...
  case DispID of
    ...
    6: if Assigned(FOnPhoneme) then
         FOnPhoneme(Self,
                    ...
                    Params[2] {Integer},
                    Params[3] {Smallint},
                    LongWord(Params[4]) {SpeechVisemeFeature},
                    Params[5] {Smallint});
    8: if Assigned(FOnViseme) then
         FOnViseme(Self,
                   ...
                   Params[1] {OleVariant},
                   Params[2] {Integer},
                   LongWord(Params[3]) {SpeechVisemeType},
                   LongWord(Params[4]) {SpeechVisemeFeature},
                   LongWord(Params[5]) {SpeechVisemeType});
  ...
  case DispID of
    ...
    3: if Assigned(FOnBookmark) then
         FOnBookmark(Self,
                     ...
                     Params[1] {OleVariant},
                     Params[2] {OleVariant},
                     LongWord(Params[3]) {SpeechBookmarkOptions});
    ...
    7: if Assigned(FOnRecognition) then
         FOnRecognition(Self,
                        Params[0] {Integer},
                        Params[1] {OleVariant},
                        LongWord(Params[2]) {SpeechRecognitionType},
    ...
    12: if Assigned(FOnInterference) then
         FOnInterference(Self,
                         Params[0] {Integer},
                         Params[1] {OleVariant},
                         LongWord(Params[2]) {SpeechInterference});
    ...
    14: if Assigned(FOnRecognizerStateChange) then
         FOnRecognizerStateChange(Self,
                                  Params[0] {Integer},
                                  Params[1] {OleVariant},
                                  LongWord(Params[2]) {SpeechRecognizerState});
...
function TSpInprocRecognizer.SetPropertyNumber(const _Name: WideString; Value: Integer): WordBool;
begin
  Result := DefaultInterface.SetPropertyNumber(_Name, Value);
end;

function TSpInprocRecognizer.GetPropertyNumber(const _Name: WideString; var Value: Integer): WordBool;
begin
  Result := DefaultInterface.GetPropertyNumber(_Name, Value);
end;

function TSpInprocRecognizer.SetPropertyString(const _Name: WideString; const Value: WideString): WordBool;
begin
  Result := DefaultInterface.SetPropertyString(_Name, Value);
end;

function TSpInprocRecognizer.GetPropertyString(const _Name: WideString; var Value: WideString): WordBool;
begin
  Result := DefaultInterface.GetPropertyString(_Name, Value);
end;
...
function TSpSharedRecognizer.SetPropertyNumber(const _Name: WideString; Value: Integer): WordBool;
begin
  Result := DefaultInterface.SetPropertyNumber(_Name, Value);
end;

function TSpSharedRecognizer.GetPropertyNumber(const _Name: WideString; var Value: Integer): WordBool;
begin
  Result := DefaultInterface.GetPropertyNumber(_Name, Value);
end;

function TSpSharedRecognizer.SetPropertyString(const _Name: WideString; const Value: WideString): WordBool;
begin
  Result := DefaultInterface.SetPropertyString(_Name, Value);
end;

function TSpSharedRecognizer.GetPropertyString(const _Name: WideString; var Value: WideString): WordBool;
begin
  Result := DefaultInterface.GetPropertyString(_Name, Value);
end;
