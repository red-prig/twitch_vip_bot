...
begin
 ...
 //reply_irc_Connect('red_prig','1892vwii6x81tyd9tz0r1m3tcrmnod','karmikkoala','54742538');

 //replyConnect_irc('red_prig','1892vwii6x81tyd9tz0r1m3tcrmnod','karmikkoala');
 //replyConnect_pub('1892vwii6x81tyd9tz0r1m3tcrmnod','54742538');
...
{
//3z934lqdrq11t3tmtydrc4frv4cb9c

Const
  clientID = '2cbrtya3bji39bnnoi6m5k59bcqw2h';
  //redirectURI = 'https://www.twitch.tv';
  redirectURI = 'http://localhost';

  scopes:array[0..11] of RawByteString=(
   'user_subscriptions',
   'user_blocks_edit',
   'user_blocks_read',
   'user_follows_edit',
...
//oauth:l8hm945ma47j3828f0yoff7py1iq5j

procedure TFrmMain.replyConnect(Sender: TObject);
var
 scopeString,url:RawByteString;
 i:SizeInt;
 DstLen:size_t;
...
begin
 ...
 msg:=
 '{"type":"MESSAGE","data":{"topic":"community-points-channel-v1.54742538","messag'+
 'e":"{\"type\":\"reward-redeemed\",\"data\":{\"timestamp\":\"2020-07-08T18:49:22.'+
 '62426474Z\",\"redemption\":{\"id\":\"c3d94d57-544d-408d-9346-a7e2ccfce57d\",\"us'+
 'er\":{\"id\":\"156899307\",\"login\":\"vrediinao_o\",\"display_name\":\"Vrediina'+
 'O_O\"},\"channel_id\":\"54742538\",\"redeemed_at\":\"2020-07-08T18:49:22.4228512'+
 '62Z\",\"reward\":{\"id\":\"9c25cd82-30e4-4e23-8dae-e3ae630b9bab\",\"channel_id\"'+
 ...
 //msg:='{"type":"reward-redeemed","data":{"timestamp":"2020-07-08T18:49:22.62426474Z","redemption":{"id":"c3d94d57-544d-408d-9346-a7e2ccfce57d","user":{"id":"156899307","login":"vrediinao_o","display_name":"VrediinaO_O"},"channel_id":"54742538","redeemed_at":"2020-07-08T18:49:22.422851262Z","reward":{"id":"9c25cd82-30e4-4e23-8dae-e3ae630b9bab","channel_id":"54742538","title":"VIP на хз сколько","prompt":"Может передумаю и  отниму випку.","cost":450000,"is_user_input_required":true,"is_sub_only":false,"image":null,"default_image":{"url_1x":"https://static-cdn.jtvnw.net/custom-reward-images/default-1.png","url_2x":"https://static-cdn.jtvnw.net/custom-reward-images/default-2.png","url_4x":"https://static-cdn.jtvnw.net/custom-reward-images/default-4.png"},"background_color":"#1F69FF","is_enabled":true,"is_paused":false,"is_in_stock":true,"max_per_stream":{"is_enabled":false,"max_per_stream":0},"should_redemptions_skip_request_queue":false,"template_id":null,"updated_for_indicator_at":"2020-07-06T17:34:56.820098059Z"},"user_input":"Просто дай випку, лол karmik3 ","status":"UNFULFILLED","cursor":"YzNkOTRkNTctNTQ0ZC00MDhkLTkzNDYtYTdlMmNjZmNlNTdkX18yMDIwLTA3LTA4VDE4OjQ5OjIyLjQyMjg1MTI2Mlo="}}}';

 //msg:='{"type":"reward-redeemed","data":{"timestamp":"2020-07-08T06:59:28.756737328Z","redemption":{"id":"3c1e58ef-f05b-4a55-98c8-2ffd09592220","user":{"id":"436730045","login":"red_prig","display_name":"Red_Prig"},"channel_id":"185900377","redeemed_at":"2020-07-08T06:59:28.688138382Z","reward":{"id":"baed79c5-ea1e-4cdc-85a7-d4551ebb87b1","channel_id":"185900377","title":"Стамина в трусы стримеру","prompt":"","cost":500,"is_user_input_required":false,"is_sub_only":false,"image":{"url_1x":"https://static-cdn.jtvnw.net/custom-reward-images/185900377/baed79c5-ea1e-4cdc-85a7-d4551ebb87b1/9e9e7b46-271c-4470-ae50-c11de08267f2/custom-1.png","url_2x":"https://static-cdn.jtvnw.net/custom-reward-images/185900377/baed79c5-ea1e-4cdc-85a7-d4551ebb87b1/9e9e7b46-271c-4470-ae50-c11de08267f2/custom-2.png","url_4x":"https://static-cdn.jtvnw.net/custom-reward-images/185900377/baed79c5-ea1e-4cdc-85a7-d4551ebb87b1/9e9e7b46-271c-4470-ae50-c11de08267f2/custom-4.png"},"default_image":{"url_1x":"https://static-cdn.jtvnw.net/custom-reward-images/default-1.png","url_2x":"https://static-cdn.jtvnw.net/custom-reward-images/default-2.png","url_4x":"https://static-cdn.jtvnw.net/custom-reward-images/default-4.png"},"background_color":"#C9CA08","is_enabled":true,"is_paused":false,"is_in_stock":true,"max_per_stream":{"is_enabled":false,"max_per_stream":0},"should_redemptions_skip_request_queue":false,"template_id":null,"updated_for_indicator_at":"2020-03-10T22:11:33.371248916Z"},"status":"UNFULFILLED","cursor":"M2MxZTU4ZWYtZjA1Yi00YTU1LTk4YzgtMmZmZDA5NTkyMjIwX18yMDIwLTA3LTA4VDA2OjU5OjI4LjY4ODEzODM4Mlo="}}}';
 ...
 Writeln('type:',msg1.Path['type'].AsStr,',',msg1.Path['data.topic'].AsStr);
 ...
 if msg<>'' then
 begin
  Writeln(msg2.Path['data.redemption.redeemed_at'].AsStr);
  DT:=Rfc3339toDateTime(msg2.Path['data.redemption.redeemed_at'].AsStr,false);

  //Writeln(GetMS(DT));

  Writeln('type2:',msg2.Path['type'].AsStr);
  Writeln('id               :',msg2.Path['data.redemption.id'].AsStr);
  Writeln('user.id          :',msg2.Path['data.redemption.user.id'].AsStr);
  Writeln('user.login       :',msg2.Path['data.redemption.user.login'].AsStr);
  Writeln('user.display_name:',msg2.Path['data.redemption.user.display_name'].AsStr);
  Writeln('redeemed_at      :',DateTimeToStr(DT));
  Writeln('reward.id        :',msg2.Path['data.redemption.reward.id'].AsStr);
  Writeln('reward.title     :',msg2.Path['data.redemption.reward.title'].AsStr);
  Writeln('reward.prompt    :',msg2.Path['data.redemption.reward.prompt'].AsStr);
  Writeln('user_input       :',msg2.Path['data.redemption.user_input'].AsStr);
 ...
 url:='270x9cxla5f7c9Z1wzt0DkCnsYGekk';
 url:='Vxq92ddFQzIQXXT2VkGfJmMs9rWmTU';

 SetLength(scopeString,Length(url));
 DstLen:=Length(url);
 base64decode(PAnsiChar(url),Length(url),PAnsiChar(scopeString),DstLen);
 Writeln('DstLen=',DstLen);
 For i:=1 to DstLen do
  Write(HexStr(Byte(scopeString[i]),2));
 Writeln;

 scopeString:=scopes[0];
 For i:=1 to High(scopes) do
 begin
  scopeString:=scopeString+' '+scopes[i];
 end;
 Writeln(scopeString);
 //url:='https://id.twitch.tv/oauth2/authorize?response_type=token&client_id='+
 //     clientID+'&redirect_uri='+redirectURI+'&scope='+Escape(scopeString);
 //u_irc.replyConnect('GET',url);

 //url:='https://id.twitch.tv/oauth2/token'+
 //     '?client_id='+clientID+
 //     '&client_secret='+'3z934lqdrq11t3tmtydrc4frv4cb9c'+
 //     '&grant_type=client_credentials'+
 //     '&scope='+Escape(scopeString);
 //
 //u_irc.replyConnect('POST',url);
end;

}

{
{"access_token":"37fz60sm4no6ni1i4d58apzmy9e2ry","expires_in":5619908,"scope":["
user_subscriptions","user_blocks_edit","user_blocks_read","user_follows_edit","c
hannel_editor","channel_commercial","channel:moderate","channel:read:redemptions
","chat:edit","chat:read","whispers:read","whispers:edit"],"token_type":"bearer"
}
}
